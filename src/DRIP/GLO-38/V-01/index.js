...
const assets = {
    nextArrow: `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="none">
...
function mainJs(body) {
    document.querySelector('body').classList.add('GLO-38');
  if(window.innerWidth < 768) {
    ...
    document.querySelector('div[data-id="8cdb5de"]').innerHTML = '';
    // setTimeout(() => {
    document.querySelector('div[data-id="8cdb5de"]').innerHTML = `
    <div class="slider-section-parent">
        <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper mySwiper2">
            ...
            <div class="next-btn">${assets.nextArrow}</div>

            <div class="prev-btn">${assets.prevArrow}</div>
        </div>
...
function swiperJs() {
 ...
 waitForElem('.elementor-section[data-id="2b6129e"]', mainJs);


// waitForElem('.elementor-section[data-id="2b6129e"] > div > div:first-child, div[data-id="8cdb5de"]', ()=>{
// 	waitForElem('Swiper', mainJs, 1, true);
// },2);
